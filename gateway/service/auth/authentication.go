...
// SqlExecutor
// mockery --exported --name=SqlExecutor --case underscore --output /Users/keshav/go/src/guardianlink/gateway/mocks/db
type Authencator interface {
...
func NewService(as Service) Authencator {
	return Service{
		Client: as.Client,
	}
}

func (as Service) Singin(c *gin.Context) (string, error) {
...
func (as Service) Singup(c *gin.Context) (string, error) {
	var newUser struct {
		Username string `json:"username"`
		Password string `json:"password"`
	}
...
func (as Service) Validate(c *gin.Context) {
